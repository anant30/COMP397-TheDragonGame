...
(function (scenes) {
    var Slide4 = (function (_super) {
        ...
        Slide4.prototype.start = function () {
            ...
            this._elevenButton = new objects.Button("ElevenButton", config.Screen.CENTER_X + 100, config.Screen.CENTER_Y + 60);
            ...
            this._twelveButton = new objects.Button("ThreeButton", config.Screen.CENTER_X + 100, config.Screen.CENTER_Y + 60);
            this.addChild(this._tenButton);
